...
<nav class="nav-extended">
	<div class="nav-wrapper light-blue darken-3">
		<a href="<?= base_url(); ?>" class="brand-logo" style="padding-left: 1em;">
			<img style="width:20%;" src="<?= site_url("css/2.png"); ?>" alt="fcc_logo"></a>
...
<!--=====================================================
			...
			<?php if ($this->session->userdata('s_level')!==NULL): ?>
				<?php if($this->session->userdata('s_level')==="1" || $this->session->userdata('s_level')==="2"): ?>
					...
					<li class="waves-effect tooltipped" data-position="bottom" data-delay="50" data-tooltip="Mensajes"><a href="<?= site_url("/CProfesor/MostrarCursosP/"); ?>"><i class="material-icons">question_answer</i></a></li>
			...
			<?php if ($this->session->userdata('s_level')!==NULL): ?>
				<?php if($this->session->userdata('s_level')==="1" || $this->session->userdata('s_level')==="2"): ?>
					...
					<ul class="collapsible" data-collapsible="accordion">
    						<li>
    						  <a class="collapsible-header" style="margin-left: 1.2em;"><i class="material-icons">account_box</i>Mensajes</a>
