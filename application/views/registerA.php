...
<div class="container">
	<div class="card-panel">
		...
		<form action="<?= site_url("/Welcome/Registrar_Tutor/"); ?>" method="POST">
			<div class="row">
				 <form class="col s10 offset-s1">
				      <div class="row">
				        ...
				        <div class="input-field col s6 offset-m1 m4 offset-l1 l4">
				          ...
				          <input id="icon_prefix" type="text" class="validate" name="cedula" required >
				        ...
				        <div class="input-field col s6 offset-m1 m4 offset-l1 l4">
				          <i class="material-icons prefix"></i>
				           ...
				           <select name="organizacion">
							  ...
							  <?php foreach ($org as $key => $org): ?>	
							  	<option value='<?php echo $org->id_organizacion;?>'><?php echo $org->nombre;?></option>
							  <?php endforeach ?>
							  
							</select> 
				          
				          <label for="icon_telephone">* Organizacion</label>
				        </div>
